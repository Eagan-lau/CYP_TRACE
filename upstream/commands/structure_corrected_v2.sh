...
for SCRIPT in audit_structure_mapping_v2.py verify_structure_associations_v2.py run_structure_matched_v2.py verify_structure_matched_v2.py structure_paired_comparisons_v2.py verify_structure_paired_v2.py; do
  "$PYTHON" "$SCRIPT"
done
