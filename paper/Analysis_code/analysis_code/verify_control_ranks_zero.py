...
output = root / 'protein_control_validation_01/REPLICATE_000_RANK_QC.json'
...
for bn, b in enumerate(blocks):
    d = np.load(result / f'block_{bn:03d}_scores.npz', allow_pickle=False)
