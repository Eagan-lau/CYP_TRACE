...
root=Path(__file__).resolve().parent; out=root/'structure_mapping_audit_01'
...
names=['audit_structure_mapping.py','STRUCTURE_EXPERT_PROTOCOL_V1.md','structure_assets_01/source_manifest.json',
